        ...
        <div class="col-sm-8 col-lg-9 border">
                    ...
                    <div class="adminsBlokLists" >
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <form action="{{route('deleteAllShop')}}" method="post">
                                    @csrf
                        ...
                        <div class="updatePanel">
                            <form action="{{route('updateAllShop')}}" method="post" enctype='multipart/form-data'>
                                @csrf
                                <input type="hidden" name="id" value="{{$val->id}}">
            ...
            <div class="card w-75 formBlock">
                ...
                <div class="card-body px-lg-5 pt-0 formBg">
                    ...
                    <!-- Form -->
                    <form class="text-center" style="color: #757575;" action="{{route('setAllShop')}}" method="post" enctype='multipart/form-data'>
                        @csrf
