...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-4 col-lg-3 border">
            ...
            <a href="{{route('getAllHotel')}}"><div class="activPage">Все Отели</div></a>
        ...
        <div class="col-sm-8 col-lg-9 border">
                    ...
                    <div class="adminsBlokLists">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <form action="{{route('deleteAllHotel')}}" method="post">
                                    @csrf
                        ...
                        <div class="updatePanel">
                            <form action="{{route('updateAllHotel')}}" method="post" enctype='multipart/form-data'>
                                @csrf
                                <input type="hidden" name="id" value="{{$val->id}}">
                                <div class="form-row">
            ...
            <div class="card w-75 formBlock">
                ...
                <div class="card-body px-lg-5 pt-0 formBg">
                    ...
                    <!-- Form -->
                    <form class="text-center" style="color: #757575;" action="{{route('setAllHotel')}}" method="post" enctype='multipart/form-data'>
                    @csrf
