...
<h2>Меню</h2>
    ...
    <div class="nav">
        ...
        <div class="big" id="null1">
            ...
            <a href="{{route('getAllRestoran')}}"><div class="activPage">Все рестораны</div></a>
            ...
            <div class="adminsBlokLists">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        ...
                        <form action="{{route('deleteAllRestoran')}}" method="post" >
                            @csrf
                ...
                <div class="updatePanel">
                    <form action="{{route('updateAllRestoran')}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        <input type="hidden" name="id" value="{{$val->id}}">
                        <div class="form-row">
...
<div class="card  w-75 formBlock">
  ...
  <div class="card-body px-lg-5 pt-0 formBg">
    ...
    <!-- Form -->
    <form class="text-center" style="color: #757575;" action="{{route('setAllRestoran')}}" method="post" enctype='multipart/form-data'>
    @csrf
      <!-- skidka -->
      <div class="md-form">
