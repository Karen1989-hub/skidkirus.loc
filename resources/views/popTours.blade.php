            ...
            <div class="list-group">
                ...
                <div class="nav">
                    <div class="big" id="null">
                        ...
                        <a href="{{route('getPopTours')}}"><div class="activPage">Туры</div></a>
        ...
        <div class="col-sm-8 col-lg-9 border">
                    ...
                    <div class="adminsBlokLists">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-6">
                                ...
                                <form action="{{route('deletePopTours')}}" method="post">
                                    @csrf
                        ...
                        <div class="updatePanel">
                            <form action="{{route('updatePopTours')}}" method="post" enctype='multipart/form-data'>
                                @csrf
                                <input type="hidden" name="id" value="{{$val->id}}">
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="popToursImg" class="custom-file-input" id="inputGroupFile01"
            ...
            <div class="card  w-75 formBlock">
                ...
                <div class="card-body px-lg-5 pt-0 formBg">
                    ...
                    <!-- Form -->
                    <form class="text-center" style="color: #757575;" action="{{route('setPopTours')}}" method="post" enctype='multipart/form-data'>
                    @csrf
