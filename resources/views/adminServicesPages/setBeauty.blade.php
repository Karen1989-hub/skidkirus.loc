...
<div class="list-group">
    ...
    <div class="nav">
        <div class="big" id="null">
            ...
            <a href="{{route('setSitsPage')}}"><div>Инстаграм</div></a>
        ...
        <div class="big" id="null1">
            ...
            <a href="{{route('getAllSites')}}"><div>Все Инстаграм</div></a>
        ...
        @foreach($beautys as $val)
            <div class="adminsBlokLists">
                ...
                <div class="updatePanel">
                    <form action="{{route('updateBeauty')}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        <input type="hidden" name="id" value="{{$val->id}}">
                        <div class="form-row">
