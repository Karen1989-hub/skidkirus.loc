...
<div class="list-group">
    ...
    <div class="nav">
        ...
        <div class="big" id="null2">
            ...
            <a href="{{route('getServicConstruction')}}"><div class="activPage">Строительство</div></a>
...
<h2>Рестораны и кафе</h2>
    ...
    <div class="cards">
        ...
        @foreach($servicConstruction as $val)
            <div class="adminsBlokLists">
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <div class="slide"><img src="img/servicConstructionImg/{{$val->nameImg}}" alt=""></div>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <button type="button" class="btn btn-success servicesUpdate">Изменить</button>
                        <form action="{{route('deleteServicConstruction')}}" method="post">
                            @csrf
                ...
                <div class="updatePanel">
                    <form action="{{route('updateServicConstruction')}}" method="post" enctype='multipart/form-data'>
                        @csrf
                        <input type="hidden" name="id" value="{{$val->id}}">
                        <div class="form-row">
...
<div class="card  w-75 formBlock">
  ...
  <div class="card-body px-lg-5 pt-0 formBg">
    ...
    <!-- Form -->
    <form class="text-center" style="color: #757575;" action="{{route('setServicConstruction')}}" method="post" enctype='multipart/form-data'>
    @csrf
      <div class="md-form">
